...
// --- Node links (Phase 18) -------------------------------------------------
// Link parse/normalize rules live in shared/node-links.ts (the renderer
// imports them too, and this module pulls node:fs). Load/save re-exports them
// for callers that go through this module.

import { parseNodeLink, parseNodeLinks } from '../shared/node-links'
export { parseNodeLink, parseNodeLinks }
